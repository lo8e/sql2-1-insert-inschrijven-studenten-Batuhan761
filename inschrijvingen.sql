...
UPDATE docenten
SET
	docenten.voorletters = 'J.',
    docenten.tussenvoegsel = '',
    docenten.achternaam = 'Dezimo'
WHERE
	docent_code = 'vlt03';
    
INSERT INTO klassen (klas_code, slb_code, cohort, opleiding_code) VALUES 
	('lo9e-amo5','crk01', 2018, 'amo');
    
INSERT INTO studenten (ov_nummer, achternaam, tussenvoegsel, voornaam) VALUES
	('97842','Kikker', '','David'),
    ('97843','Kakker', '','Keloy');
...
DELETE FROM klassen_studenten
WHERE ov_nummer = '97843';
